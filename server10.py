...
import socket
import io
from scapy.all import rdpcap, IP, Ether,TCP,Padding,Raw
import argparse
import sys

def pcap_file():
    parser = argparse.ArgumentParser(description="處理 PCAP 檔案的 Server 程式")
    ...
    return target_pcap
def connect_server(host='0.0.0.0', port=65432):
...
if __name__ == "__main__":
    target_file = pcap_file()
    print(target_file)
    #target_file = r"tcp3.pcap"
